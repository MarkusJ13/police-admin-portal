...
export class AddJob extends React.Component {
  ...
  constructor(props, context) {
    super(props, context);
    const {name, id, phone, badge} = props;
    this.state = {
      isOpen: true,
      user: {
        name,
  ...
  render() {
    ...
    return (
      <ReactModal
        ...
        <h2>{mode === 'edit' ? 'Update user' : 'Add a user'}</h2>
            ...
            <div className="col-10">
              <div className="card">
                ...
                <form onSubmit={this.handleSubmit} className="card-body">
                  ...
                  <div className="form-group">
                    <label htmlFor="add-user-phone">Badge No.</label>
                    <input
                      id="add-user-id"
                      value={badge}
                  ...
                  <button
                    ...
                    {mode === 'edit'
                      ...
                      : `${isUpdating ? 'Adding new user...' : 'Add new user'}`}
                  </button>
                </form>
              </div>
            </div>
